class FunctionsController < ApplicationController
  ...
  # GET /functions.json
  def index
    @functions = Function.paginate(:page => params[:page], :per_page => 5)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @function.save
        format.html { redirect_to @function, notice: 'Función creada.' }
  ...
  def update
    respond_to do |format|
      if @function.update(function_params)
        format.html { redirect_to @function, notice: 'Función actualizada correctamente.' }
  ...
  def destroy
    @function.destroy
    respond_to do |format|
      format.html { redirect_to functions_url, notice: 'Función eliminada.' }
  ...
  private
    ...
    def function_params
      params.require(:function).permit(:function, :description)
    end
end
