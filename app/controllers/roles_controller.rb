class RolesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @role.save
        format.html { redirect_to @role, notice: 'El rol fue creado satisfactoriamente.' }
  ...
  def destroy
    @role.destroy
    respond_to do |format|
      format.html { redirect_to roles_url, notice: 'El rol fue eliminado satisfactoriamente.' }
